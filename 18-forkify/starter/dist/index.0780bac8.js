...
})({"1OcUa":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
const stallFetch = async function(s) {
...
///////////////////////////////////////
// Note that on slower connections, the svg finishes loading AFTER the fetch ans json process for some reason.. Either make the svg faster or promise.race a timer vs the load event of the svg
...
const showRecipe = async function() {
    try {
        ...
        // await renderSpinner(recipeContainer);
        const res = await fetch(// 'https://forkify-api.herokuapp.com/api/v2/recipes/5ed6604591c37cdc054bce26'
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","url:../img/icons.svg":"ivMBe","core-js/modules/web.immediate.js":"49tUX","regenerator-runtime/runtime":"dXNgZ"}],"gkKU3":[function(require,module,exports) {
...
module.exports = require('./helpers/bundle-url').getBundleURL('iCBHk') + "icons.dfd7a6db.svg" + "?" + Date.now();
...
},{}]},["1OcUa","4pVL1"], "4pVL1", "parcelRequire3a11")
